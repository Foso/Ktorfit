...
mavenPublishing {
    ...
    coordinates(
        ...
        "ktorfit-converters-websocket",
        libs.versions.ktorfitWebSocketConverter.get()
    )
...
android {
    ...
    namespace = "de.jensklingenberg.ktorfit.converters.WebSocket"
}
    ...
    publications {
        create<MavenPublication>("default") {
            ...
            pom {
                ...
                description.set("WebSocket Converter for Ktorfit")
