...
class PartsArgumentTextKtTest{
    ...
    fun returnPartsWithPartAnnotation() {
        ...
        val parameterData = ParameterData("test1", ReturnTypeData("String","kotlin.String"), annotations = listOf(partAnnotation))
        val params = listOf(parameterData)
       val text = getPartsArgumentText(params)
    ...
    fun returnPartsWithPartMapAnnotation() {
        ...
        val parameterData1 = ParameterData("test1", ReturnTypeData("String","kotlin.String"), annotations = listOf(partMapAnnotation))
        val parameterData2 = ParameterData("test2", ReturnTypeData("String","kotlin.String"))
    ...
    fun returnPartsWithPartAnnotationAndPartMapAnnotation() {
        ...
        val parameterData1 = ParameterData("test1", ReturnTypeData("String","kotlin.String"), annotations = listOf(partMapAnnotation))
        val parameterData2 = ParameterData("test2", ReturnTypeData("String","kotlin.String"), annotations = listOf(partAnnotation))
