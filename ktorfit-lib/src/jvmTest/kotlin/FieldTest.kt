    ...
    fun testFieldWithString() {
        ...
        runBlocking {
            val requestData = RequestData(
                ...
                fields = listOf(DH(testKey, testValue, false, "FieldType.FIELD")),
            )
    ...
    fun testFieldWithEncodedString() {
        ...
        runBlocking {
            val requestData = RequestData(
                ...
                relativeUrl = "",
                returnTypeData = TypeData("kotlin.String"),
                fields = listOf(DH(testKey, testValue, true, "FieldType.FIELD")),
            )
            KtorfitClient(ktorfit).suspendRequest<String, String>(requestData)
        }
    }
    ...
    fun whenFieldMapContainsNullValues_SkipTheNullValues() {
        ...
        runBlocking {
            val requestData = RequestData(
                ...
                relativeUrl = "",
                returnTypeData = TypeData("kotlin.String"),
                fields = listOf(DH(testKey, testMap, false, "FieldType.FIELDMAP"))
            )
            KtorfitClient(ktorfit).suspendRequest<String, String>(requestData)
        }
    }
