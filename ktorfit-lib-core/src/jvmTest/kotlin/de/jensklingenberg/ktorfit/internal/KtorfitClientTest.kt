...
class ClientTest {
    ...
    fun checkIfCorrectHttpMethodIsSet() {
        ...
        runBlocking {
            ktorfit.create<ClientTestApi>(_ClientTestApiImpl.Companion).checkCorrectHttpMethod()
        }
    ...
    fun throwExceptionWhenResponseConverterMissing() {
        try {
            ...
            runBlocking {
                ktorfit.create<ClientTestApi>(_ClientTestApiImpl.Companion).converterMissing()
            }
    ...
    fun whenUrlValueContainsFullUrl_ThenRemoveBaseUrl() {
        ...
        try {
            runBlocking {
                ktorfit.create<ClientTestApi>(_ClientTestApiImpl.Companion).whenUrlValueContainsBaseUrl_ThenRemoveBaseUrl()
